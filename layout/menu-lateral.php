...
<?php $url = str_replace("Novo/", "", $_SERVER["REQUEST_URI"]); ?>
<sidebar id="menu-lateral" class="menu-lateral">
    <div class="conteudo-esquerdo">
        <div class="principal">
            ...
            <nav class="nav-bar">
                <div class="box-nav-bar">
                    <a class="nav-bar__title <?php if($url == BASEURL.'index.php'){ echo 'active-title';} ?>" href="<?php echo BASEURL;?>index.php">                        
                        <svg class="ico-nav " xmlns="http://www.w3.org/2000/svg" id="Outline" viewBox="0 0 24 24" width="512" height="512"><path d="M23,22H3a1,1,0,0,1-1-1V1A1,1,0,0,0,0,1V21a3,3,0,0,0,3,3H23a1,1,0,0,0,0-2Z"/><path d="M15,20a1,1,0,0,0,1-1V12a1,1,0,0,0-2,0v7A1,1,0,0,0,15,20Z"/><path d="M7,20a1,1,0,0,0,1-1V12a1,1,0,0,0-2,0v7A1,1,0,0,0,7,20Z"/><path d="M19,20a1,1,0,0,0,1-1V7a1,1,0,0,0-2,0V19A1,1,0,0,0,19,20Z"/><path d="M11,20a1,1,0,0,0,1-1V7a1,1,0,0,0-2,0V19A1,1,0,0,0,11,20Z"/></svg>
                        Dashboard                        
                    </a>
                </div>
                <div class="box-nav-bar">
                    <span class="nav-bar__title <?php 
                                    if(
                                        $url == BASEURL.'nav/produto/produtos.php' or 
                                        $url == BASEURL.'nav/produto/importarCsv.php' or 
                                        $url == BASEURL.'nav/produto/cadastroProd.php' or 
                                        $url == BASEURL.'nav/produto/entradaProd.php' or                                     
                                        $url == BASEURL.'nav/produto/saidaProd.php' or                                     
                                        $url == BASEURL.'nav/produto/relatorio.php'
                                    ){ echo 'active-title';} 
                    ?>">
                    ...
                    ?>">
                            <a class="nav-bar__item <?php if($url == BASEURL.'nav/produto/produtos.php'){ echo 'active-list';} ?>" href="<?php echo BASEURL;?>nav/produto/produtos.php">Listar Produtos</a></li>
                        <?php if($_SESSION['nivel'] >= 1){ ?> 
                            <a class="nav-bar__item <?php if($url == BASEURL.'nav/produto/importarCsv.php'){ echo 'active-list';} ?>" href="<?php echo BASEURL;?>nav/produto/importarCsv.php">Importar Planilha</a>
                            <a class="nav-bar__item <?php if($url == BASEURL.'nav/produto/cadastroProd.php'){ echo 'active-list';} ?>" href="<?php echo BASEURL;?>nav/produto/cadastroProd.php">Cadastrar Produtos</a>
                            <a class="nav-bar__item <?php if($url == BASEURL.'nav/produto/entradaProd.php'){ echo 'active-list';} ?>" href="<?php echo BASEURL;?>nav/produto/entradaProd.php">Entrada de Produtos</a>
                            <a class="nav-bar__item <?php if($url == BASEURL.'nav/produto/saidaProd.php'){ echo 'active-list';} ?>" href="<?php echo BASEURL;?>nav/produto/saidaProd.php">Saída de Produtos</a>
                        
                         <?php } if($_SESSION['nivel'] >= 2){?> 
                            <a class="nav-bar__item <?php if($url == BASEURL.'nav/produto/relatorio.php'){ echo 'active-list';} ?>" href="<?php echo BASEURL;?>nav/produto/relatorio.php">Relatório de Entrada/Saída</a>
                         <?php } ?> 
                    </div>
                </div>
                <div class="box-nav-bar">
                     <?php if($_SESSION['nivel'] > 1){ ?> 
                        <span class="nav-bar__title <?php 
                                    if(
                                        $url == BASEURL.'nav/usuario/usuarios.php' or 
                                        $url == BASEURL.'nav/usuario/cadastro.php'
                                    ){ echo 'active-title';} 
                    ?>">
                    ...
                    ?>">
                            <a class="nav-bar__item <?php if($url == BASEURL.'nav/usuario/usuarios.php'){ echo 'active-list';} ?>" href='<?php echo BASEURL;?>nav/usuario/usuarios.php'>Listar Usuários</a>
                            <a class="nav-bar__item <?php if($url == BASEURL.'nav/usuario/cadastro.php'){ echo 'active-list';} ?>" href='<?php echo BASEURL;?>nav/usuario/cadastro.php'>Cadastrar Usuario</a>
                        </div>
                     <?php } ?> 
                </div>
            </nav>
        ...
        <footer class="footer">
            <div class="box-conta">
                <a data-tooltip="Minha Conta" href="<?php echo BASEURL;?>nav/usuario/minhaConta.php"><svg xmlns="http://www.w3.org/2000/svg" id="Outline" viewBox="0 0 24 24" width="512" height="512"><path d="M12,12A6,6,0,1,0,6,6,6.006,6.006,0,0,0,12,12ZM12,2A4,4,0,1,1,8,6,4,4,0,0,1,12,2Z"/><path d="M12,14a9.01,9.01,0,0,0-9,9,1,1,0,0,0,2,0,7,7,0,0,1,14,0,1,1,0,0,0,2,0A9.01,9.01,0,0,0,12,14Z"/></svg></a>
            </div>
